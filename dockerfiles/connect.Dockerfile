...
# This may be needed if you are behind a corporate firewall. The certificate is not included in the repository. This
# is an example. You'll need to include your certificate and update the filename accordingly.
